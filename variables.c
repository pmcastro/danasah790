...
char nombre[]="DanaSah 7.9 LimitStrength";	    /* nombre para la version limitada en fuerza */
#else
char nombre[]="DanaSah 7.9";					/* nombre para la version con maxima fuerza */
#endif
char fecha[]="11/06/2019";
...
char elo_type[32] = "FIDE";					    /* tipo de elo: fide, uscf, active, ccrl */
int elo = 1500;									/* ajusta elo segun oponente si está limitada la fuerza */
int style = 3;									/* el estilo de juego se podra hacer mas pasivo o agresivo */
int diff_engine = 50;							/* permite ajustar el elo para un motor y una determinada lista de ranking */
int elo_fide;
int elo_uscf;
int elo_active;
int elo_ccrl;
...
int guarda_diff_chesscomputer_engine = 0;
int guarda_diff_human_chesscomputer = 0;
